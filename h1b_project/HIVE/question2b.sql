Select worksite, count(case_status) as counted, year from h1b_final where year ='2011' and case_status='CERTIFIED' group by worksite, year order by counted desc limit 5;
...
select worksite, count(case_status) as counted, year from h1b_final where year ='2014' and case_status='CERTIFIED' group by worksite, year order by counted desc limit 5;
...
select worksite, count(case_status) as counted, year from h1b_final where year ='2016' and case_status='CERTIFIED' group by worksite, year order by counted desc limit 5;
