...
public class USPartDataEngineer {
	...
	public static class DataEngineer1Partitioner extends Partitioner < Text, LongWritable > 
	{
	...
	public static void main(String args[])  throws IOException, InterruptedException, ClassNotFoundException
	{
		  ...
		  job.setJarByClass(USPartDataEngineer.class);
		  job.setMapperClass(MapClass.class);
		  job.setPartitionerClass(DataEngineer1Partitioner.class);
